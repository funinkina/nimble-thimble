...
const FOOT_BTN =
  "flex w-full items-center gap-2.5 border-b border-white/10 px-4 py-3 font-mono text-label uppercase bg-raised text-primary transition-colors duration-150 ease-nothing hover:bg-border cursor-pointer [&_svg]:size-[16px]";
const FOOT_BTN_COLLAPSED =
  "flex w-full items-center justify-center border-b border-white/10 py-3 bg-raised text-primary transition-colors duration-150 ease-nothing hover:bg-border cursor-pointer [&_svg]:size-[16px]";
